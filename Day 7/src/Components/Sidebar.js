...
import { FaUserPlus,FaUser,FaMusic,FaHome,FaBars,FaInstagram,FaTwitter,FaYoutube,FaFacebook,FaLinkedin} from 'react-icons/fa';
    ...
    <div className='sidebarsection'>
      <div className="homepage">
        ...
        <div className="leftsection">
          <div>
            <button className='head3'> <div className='head1'><FaBars size={16} />   Your PlayList </div>  <div>  <FaUserPlus onClick={handleOpenPopup} className='head2'/> </div></button>
          </div>
                  ...
                  {playlists.length === 0 ? (
                      ...
                      <ul className='newlists'>
                        {playlists.map((playlist, index) => (
                          <li key={index}><button  className='playbutton'>{playlist.name}</button></li>
                        ))}
                      </ul>
                  )}
                </div>
                  ...
                  <h4>PlayList Name</h4>
                    <form className='formpop'>
                      <input type="text" value={playlistName} onChange={handlePlaylistNameChange} /><br />
                        <button type="button" onClick={handleCreatePlaylist}>Create</button>
